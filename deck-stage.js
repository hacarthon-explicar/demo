 ...
 *      an `x-op` CustomEvent on the element and do
...
(() => {
  ...
  class DeckStage extends HTMLElement {
    ...
    _onMessage(e) {
      ...
      // Host has processed the op; rail input is safe again.
    ...
    _emitDcOp(op, slide, lock, newIndex) {
      ...
      // The stamp is on the WRAPPER, not this element. closest() finds it (or this element's
      ...
      this.dispatchEvent(new CustomEvent('x-op', {
